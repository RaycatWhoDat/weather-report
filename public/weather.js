...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  var Temperature = (props) => {
    ...
    return /* @__PURE__ */ import_react.default.createElement("article", {
      id: "temperature",
      className: "flex flex-column items-center justify-center pt4 tc"
    }, /* @__PURE__ */ import_react.default.createElement("section", {
      className: "w-one-third br-100 pa1 ba b-black pointer"
    }, /* @__PURE__ */ import_react.default.createElement("div", {
      className: "br-100 bg-black pa4 white"
    }, /* @__PURE__ */ import_react.default.createElement("span", {
      className: "f-subheadline white"
    }, currentTemperature))), /* @__PURE__ */ import_react.default.createElement("p", {
      className: "ma0 f3 pt4 pb3"
    }, dayType), /* @__PURE__ */ import_react.default.createElement("p", {
      className: "ma0 f4 bb b-black w-90 mid-gray pb4"
    }, todaysDate, " \xB7 ", zipCode));
  };
  ...
  var DayType;
  (function(DayType2) {
    DayType2["SUNNY"] = "Sunny";
    DayType2["PARTLY_CLOUDY"] = "Partly cloudy";
    DayType2["CLOUDY"] = "Cloudy";
    DayType2["RAINY"] = "Rainy";
    DayType2["THUNDERSTORMS"] = "Thunderstorms";
    DayType2["SNOW"] = "Snow";
  })(DayType || (DayType = {}));
  ...
  var DayReport = (props) => {
    ...
    const getDayTypeName = (dayType2) => forecastMapping[dayType2] ?? "";
    const NO_DATA_SYMBOL = "--";
    return /* @__PURE__ */ import_react2.default.createElement("section", {
      id: "day-report",
      className: "flex flex-column justify-center pv4 tc"
    }, /* @__PURE__ */ import_react2.default.createElement("span", {
      className: "f5 pv2 mid-gray"
    }, dayOfWeek), /* @__PURE__ */ import_react2.default.createElement("ion-icon", {
      name: getDayTypeName(dayType),
      size: "large"
    }), /* @__PURE__ */ import_react2.default.createElement("span", {
      className: "f4 pt2"
    }, high ?? NO_DATA_SYMBOL, "\xB0"), /* @__PURE__ */ import_react2.default.createElement("span", {
      className: "f6 pt1 pb2 mid-gray"
    }, low ?? NO_DATA_SYMBOL, "\xB0"));
  };
  var WeeklyReport = (props) => {
    ...
    for (let index = 0; index < 5; index++) {
      ...
      const dayReport = /* @__PURE__ */ import_react2.default.createElement(DayReport, {
        key: index,
        dayOfWeek,
        high,
        low,
    ...
    return /* @__PURE__ */ import_react2.default.createElement("article", {
      id: "weekly-report",
      className: "flex justify-center items-center w-100 tc"
    }, /* @__PURE__ */ import_react2.default.createElement("section", {
      className: "flex justify-around bb b-black w-90"
    }, dayReports));
  };
  var WeeklyReport_default = WeeklyReport;

  // src/components/Toolbar.tsx
  var import_react3 = __toModule(require_react());
  var Toolbar = (props) => {
    const {setZipCode} = props ?? {};
    const getNewForecast = (event) => {
      event.preventDefault();
      const inputField = document.getElementById("zip-code");
    ...
    return /* @__PURE__ */ import_react3.default.createElement("article", {
      id: "toolbar",
      className: "flex justify-center w-100"
    }, /* @__PURE__ */ import_react3.default.createElement("section", {
      className: "flex items-center pv2 w-90 br3 mt5 ba b-black tc"
    }, /* @__PURE__ */ import_react3.default.createElement("div", {
      className: "w-one-third ma1"
    }, /* @__PURE__ */ import_react3.default.createElement("span", {
      className: "f4 white bg-black bold br3 pv2 ph4"
    }, "Weather in...")), /* @__PURE__ */ import_react3.default.createElement("div", {
      className: "w-two-thirds mr5"
    ...
    }, /* @__PURE__ */ import_react3.default.createElement("ion-icon", {
      name: "search-outline",
      size: "large"
    }))));
  };
  ...
  var App = () => {
    ...
    const [zipCode, setZipCode] = (0, import_react4.useState)("60618");
    const [weatherForecast, setWeatherForecast] = (0, import_react4.useState)({});
    const fetchWeather = async (zipCode2) => await import_axios.default.get(`/weather/${zipCode2}`);
    ...
    return /* @__PURE__ */ import_react4.default.createElement("article", {
      id: "app",
      className: "bg-white"
    }, /* @__PURE__ */ import_react4.default.createElement(Temperature_default, {
      zipCode,
      todaysDate,
      weatherForecast
    }), /* @__PURE__ */ import_react4.default.createElement(WeeklyReport_default, {
      weatherForecast
    }), /* @__PURE__ */ import_react4.default.createElement(Toolbar_default, {
      setZipCode
    }));
  };
